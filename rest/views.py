...
from rest.models import GalleryImage, GalleryVideo, GalleryAudio, GalleryClipAudio, GalleryClipVideo
from rest.serializers import ImageSerializer, VideoSerializer, AudioSerializer, ClipAudioSerializer, ClipVideoSerializer
